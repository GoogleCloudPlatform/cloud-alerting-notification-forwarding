...
"""Unit tests for pubsub.py under utilities/"""
import unittest
from unittest.mock import Mock
from google.cloud import storage
from utilities import pubusb

# class PubSubTest(unittest.TestCase):
#     def testAbstactPubSubCanNotBeInitialized(self):
#         with self.assertRaises(TypeError):
#             pubsub.PubSub()  # pylint: disable=abstract-class-instantiated 
