...
_VALID_CONFIG_MAP = {'channel-1': {'service_name': 'chat', 'webhook_url': 'https://chat.123.com'}}
...
class GcsConfigServerTest(unittest.TestCase):
    def setUp(self):
        ...
        self._test_server = config_server.GcsConfigServer(self._test_bucket, self._test_filename)
